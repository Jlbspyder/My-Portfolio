const projects = [
  ...
  },
   {
    ...
    image:  "/voice-ai-assistant.png",
    liveDemo: true,
    privateCode: false,
    description: "A full-stack voice-powered AI assistant that transcribes spoken questions, generates contextual text responses, detects silence automatically, and uses live web search to provide up-to-date answers.",
    stack: ["React", "TypeScript", "Node.js", "Express", "Supabase", "Groq API", "Tailwind CSS"],
    demo: "https://voice-text-app-nu.vercel.app",
    repo: "https://github.com/Jlbspyder/voice-text-app"
  },
  {
    id: 3,
    ...
    stack: ["React", "JavaScript", "Redux Toolkit", "Node.js", "Express", "PayPal", "JWT"],
    ...
    stack: ["React", "JavaScript", "Express", "Neon", "Prisma", "JWT", "Tailwind CSS"],
